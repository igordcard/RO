...
class vim_thread(threading.Thread):
            ...
            try:
                ...
                if task["status"] == "SUPERSEDED":
                    ...
                    if task["action"] == "CREATE":
                        ...
                        result, database_update = self.get_sfi(task)
                    else:
                        raise vimconn.vimconnException(self.name + "unknown task action {}".format(task["action"]))
                    ...
                    if task["action"] == "CREATE":
                        ...
                        result, database_update = self.get_sf(task)
                    else:
                        raise vimconn.vimconnException(self.name + "unknown task action {}".format(task["action"]))
                    ...
                    if task["action"] == "CREATE":
                        ...
                        result, database_update = self.get_classification(task)
                    else:
                        raise vimconn.vimconnException(self.name + "unknown task action {}".format(task["action"]))
                    ...
                    if task["action"] == "CREATE":
                        ...
                        result, database_update = self.get_sfp(task)
                    else:
                        raise vimconn.vimconnException(self.name + "unknown task action {}".format(task["action"]))
                else:
    ...
    def get_sfi(self, task):
        self.logger.debug("IGOR get_sfi")
        return

    def new_sfi(self, task):
        self.logger.debug("IGOR new_sfi")
        vim_sfi_id = None
        try:
            params = task["params"]
            task_id = task["instance_action_id"] + "." + str(task["task_index"])
            ...
            instance_element_update = {"status": "BUILD", "vim_sfi_id": vim_sfi_id, "error_msg": None}
            return True, instance_element_update
    ...
    def del_sfi(self, task):
        self.logger.debug("IGOR del_sfi")
    ...
    def get_sf(self, task):
        self.logger.debug("IGOR get_sf")
        return

    def new_sf(self, task):
        self.logger.debug("IGOR new_sf")
        vim_sf_id = None
        try:
            params = task["params"]
            task_id = task["instance_action_id"] + "." + str(task["task_index"])
            ...
            instance_element_update = {"status": "BUILD", "vim_sf_id": vim_sf_id, "error_msg": None}
            return True, instance_element_update
    ...
    def get_classification(self, task):
        self.logger.debug("IGOR get_classification")
        return

    def new_classification(self, task):
        self.logger.debug("IGOR new_classification")
        ...
        try:
            ...
            instance_element_update = {"status": "BUILD", "vim_classification_id": vim_classification_id, "error_msg": None}
            return True, instance_element_update
    ...
    def del_classification(self, task):
        self.logger.debug("IGOR del_classification")
    ...
    def get_sfp(self, task):
        self.logger.debug("IGOR get_sfp")
        return

    def new_sfp(self, task):
        self.logger.debug("IGOR new_sfp")
        vim_sfp_id = None
        try:
            params = task["params"]
            task_id = task["instance_action_id"] + "." + str(task["task_index"])
            ...
            instance_element_update = {"status": "BUILD", "vim_sfp_id": vim_sfp_id, "error_msg": None}
            return True, instance_element_update
    ...
    def del_sfp(self, task):
        self.logger.debug("IGOR del_sfp")
